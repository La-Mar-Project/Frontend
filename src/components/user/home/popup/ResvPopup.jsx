...
export default function ResvPopup({ isOpen, date, onClose, onConfirm }) {
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className="bg-white rounded-[10px] w-[870px] shadow-xl max-h-[85vh] flex flex-col">
          ...
          <div className="flex flex-col gap-[80px]">
            ...
            <section className=" flex gap-[70px]">
              ...
              <div className="text-[24px] font-[700] flex justify-center items-center gap-[9px]">
                <p className="text-red-notifi-t">90,000</p>원
              </div>
            </section>
            <section className="flex gap-[70px]">
            ...
            <section className="flex flex-col gap-[25px]">
              <div className="flex gap-[80px]">
                <p className="pl-[75px] text-[22px] font-semibold">약관동의</p>
